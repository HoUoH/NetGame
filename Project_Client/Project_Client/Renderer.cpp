...
void Renderer::Initialize(int windowSizeX, int windowSizeY)
{
	...
	//Load shaders
	m_SolidRectShader = CompileShaders((char*)"./Shaders/SolidRect.vs", (char*)"./Shaders/SolidRect.fs");
	m_TextureRectShader = CompileShaders((char*)"./Shaders/TextureRect.vs", (char*)"./Shaders/TextureRect.fs");
	m_TextureRectSeqShader = CompileShaders((char*)"./Shaders/TextureRectSeq.vs", (char*)"./Shaders/TextureRectSeq.fs");

	//Load shadow texture
	m_TexShadow = CreatePngTexture((char*)"./shadow.png");
